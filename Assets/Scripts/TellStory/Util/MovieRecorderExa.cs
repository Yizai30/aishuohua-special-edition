...
namespace UnityEngine.Recorder.Examples
{
    ...
    /// </summary>
    public class MovieRecorderExa : MonoBehaviour
    {
        ...
        internal void Initialize()
        {
            ...
            //var mediaOutputFolder = new DirectoryInfo(Path.Combine(Application.dataPath, "..", "RecordMovie"));
            var mediaOutputFolder = new DirectoryInfo(Application.persistentDataPath + "/video");
            ...
            m_Settings.OutputFile = mediaOutputFolder.FullName + "/" + "tempVideo";
