...
import com.setik.androidutils.AndroidUtils;
...
public class ScreenRecordService extends Service {
    ...
    private long maxFileSize = Constants.NO_SPECIFIED_MAX_SIZE;
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        //Start Recording
            ...
            mIntent = intent;
            maxFileSize = intent.getLongExtra(Constants.MAX_FILE_SIZE_KEY, Constants.NO_SPECIFIED_MAX_SIZE);
            ...
            videoBitrate = intent.getIntExtra("videoBitrate", 288 * 1024);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (manager != null) {
                    ...
                    if (notificationSmallIcon != null) {
                        ...
                        //Modify notification badge
                        notification = new Notification.Builder(getApplicationContext(), channelId).setOngoing(true).setContentTitle(notificationTitle).setContentText(notificationDescription).addAction(action).build();//.setSmallIcon(R.drawable.icon)
                    }
            ...
            mMediaRecorder.setOnErrorListener(new MediaRecorder.OnErrorListener() {
                ...
                public void onError(MediaRecorder mediaRecorder, int what, int extra) {
                    ...
                    ResultReceiver receiver = intent.getParcelableExtra(ScreenRecordService.BUNDLED_LISTENER);
                    Bundle bundle = new Bundle();
                    bundle.putInt(Constants.ERROR_KEY, Constants.SETTINGS_ERROR);
                    bundle.putString(Constants.ERROR_REASON_KEY, String.valueOf(what));
                    if (receiver != null) {
                        receiver.send(Activity.RESULT_OK, bundle);
                    }
                }
            ...
            mMediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener() {
                ...
                public void onInfo(MediaRecorder mr, int what, int extra) {
                    if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED) {
                        ...
                        ResultReceiver receiver = intent.getParcelableExtra(ScreenRecordService.BUNDLED_LISTENER);
                        Bundle bundle = new Bundle();
                        bundle.putInt(Constants.ERROR_KEY, Constants.MAX_FILE_SIZE_REACHED_ERROR);
                        bundle.putString(Constants.ERROR_REASON_KEY, getString(R.string.max_file_reached));
                        if (receiver != null) {
                            receiver.send(Activity.RESULT_OK, bundle);
                        }
                    }
            ...
            try {
                ...
                ResultReceiver receiver = intent.getParcelableExtra(ScreenRecordService.BUNDLED_LISTENER);
                Bundle bundle = new Bundle();
                bundle.putInt(Constants.ON_START_KEY, Constants.ON_START);
                if (receiver != null) {
                    receiver.send(Activity.RESULT_OK, bundle);
                }
            } catch (Exception e) {
...
//        }
        ...
        String fname = sp.getString("videoFileName", "test.mp4");
        Log.i("Unity", "fname: " + fname);
        AndroidUtils.filename = fname;
        filePath = path + "/" + AndroidUtils.filename;
...
//        }
        ...
        Log.i("Unity", "videoEncoderAsInt: " + videoEncoderAsInt);
        ...
        if ( maxFileSize > Constants.NO_SPECIFIED_MAX_SIZE) {
