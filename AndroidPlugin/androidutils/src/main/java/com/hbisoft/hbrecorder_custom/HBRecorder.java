...
import static com.hbisoft.hbrecorder_custom.Constants.ERROR_KEY;
import static com.hbisoft.hbrecorder_custom.Constants.ERROR_REASON_KEY;
import static com.hbisoft.hbrecorder_custom.Constants.GENERAL_ERROR;
import static com.hbisoft.hbrecorder_custom.Constants.MAX_FILE_SIZE_KEY;
import static com.hbisoft.hbrecorder_custom.Constants.NO_SPECIFIED_MAX_SIZE;
import static com.hbisoft.hbrecorder_custom.Constants.ON_COMPLETE_KEY;
import static com.hbisoft.hbrecorder_custom.Constants.ON_START_KEY;
...
public class HBRecorder implements com.hbisoft.hbrecorder_custom.MyListener {
    ...
    private com.hbisoft.hbrecorder_custom.FileObserver observer;
    private final com.hbisoft.hbrecorder_custom.HBRecorderListener hbRecorderListener;
    private byte[] byteArray;
    private int vectorDrawable = 0;
    private String audioSource = "MIC";
    private String videoEncoder = "H264";
    ...
    public int getDefaultWidth(){
        com.hbisoft.hbrecorder_custom.HBRecorderCodecInfo hbRecorderCodecInfo = new com.hbisoft.hbrecorder_custom.HBRecorderCodecInfo();
    ...
    public int getDefaultHeight(){
        com.hbisoft.hbrecorder_custom.HBRecorderCodecInfo hbRecorderCodecInfo = new HBRecorderCodecInfo();
        hbRecorderCodecInfo.setContext(context);
    ...
    public String getFilePath() {
        return com.hbisoft.hbrecorder_custom.ScreenRecordService.getFilePath();
    }

    /*Get file name and extension*/
    public String getFileName() {
        return com.hbisoft.hbrecorder_custom.ScreenRecordService.getFileName();
    }
    ...
    public void stopScreenRecording() {
        Intent service = new Intent(context, com.hbisoft.hbrecorder_custom.ScreenRecordService.class);
    ...
    public boolean isBusyRecording() {
        ...
        if (manager != null) {
            for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
                if (com.hbisoft.hbrecorder_custom.ScreenRecordService.class.getName().equals(service.service.getClassName())) {
                    return true;
                }
            }
        }
        ...
        try {
            if (!mWasUriSet) {
                if (outputPath != null) {
                    ...
                    observer = new com.hbisoft.hbrecorder_custom.FileObserver(parent, HBRecorder.this);
                } else {
                    observer = new com.hbisoft.hbrecorder_custom.FileObserver(String.valueOf(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES)), HBRecorder.this);
                }
                observer.startWatching();
            }

            service = new Intent(context, com.hbisoft.hbrecorder_custom.ScreenRecordService.class);
            if (mWasUriSet) {
            ...
            service.putExtra(com.hbisoft.hbrecorder_custom.ScreenRecordService.BUNDLED_LISTENER, new ResultReceiver(new Handler()) {
                @Override
    ...
    com.hbisoft.hbrecorder_custom.Countdown countDown = null;
