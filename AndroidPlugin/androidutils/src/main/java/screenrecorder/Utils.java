...
public class Utils {
    ...
    public static void findEncodersByTypeAsync(String mimeType, Callback callback) throws Exception {
        AsyncTask task = new EncoderFinder(callback).execute(mimeType);
